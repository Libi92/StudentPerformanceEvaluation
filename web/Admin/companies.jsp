    ...
    <body>
        ...
        <div class="blog">
            <div class="container">
                    ...
                    <div class="col-md-6 col-md-offset-1">
                        ...
                        <form class="form-horizontal" method="post" action="../Companies">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="name" required pattern="[a-zA-Z]+" id="name" placeholder="Name" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4" for="location">Location</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="location" pattern="[a-zA-Z]+" required id="location" placeholder="Location" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4" for="platforms">Platforms</label>
                                <div class="col-md-8">
                                    <textarea class="form-control" name="platforms" id="platforms" pattern="[a-zA-Z]+" required placeholder="Platforms"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div class="col-md-8">
                    <%                        
                        ResultSet rs = DBUtils.getCompanies();
                        if (rs.next()) {
                    %>
                    ...
                    %>
                    <div class="alert alert-info" role="alert">No Companies Added</div>
                    <%
                        }
                    %>
                </div>
