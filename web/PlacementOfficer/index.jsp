            ...
            <div class="container">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <form class="form-horizontal" method="post" action="../ChangePassword">
                        <input type="hidden" name="returnurl" value="PlacementOfficer/" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="password" class="form-control" name="cpassword" required id="cpassword" placeholder="Confirm Password" />
                            </div>
                        </div>
                        <div class="form-group">
