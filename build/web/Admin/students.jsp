        ...
        <div class="blog">
            <div class="container">
                ...
                <div class="col-md-6 col-md-offset-1">
                    ...
                    %>
                    <form class="form-horizontal" method="post" action="../RegisterStudent">
                        ...
                        <div class="form-group">
                            <label class="col-md-4" for="roll">Roll No</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="roll" required id="roll" onkeypress="return isNumber(event)" placeholder="Roll No" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-4" for="admisnyear">Year of Admission</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" required name="admisnyear" onkeypress="return isNumber(event)" id="admisnyear" placeholder="Year of Admission" />
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group" data-provide="datepicker">
                                    <input type="text" class="form-control datepicker" required name="dob" id="dob">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" required name="contact" pattern="[789][0-9]{9}" onkeypress="return isNumber(event)" id="contact" placeholder="Contact" />
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="panel-group" id="accordion">
                        ...
                        <%
                            for(String key : Globals.Departments.keySet()){
                                if(key.equals(Globals.SELECT_KEY))
                                    continue;
                        %>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#<%= key %>"><%= Globals.Departments.get(key) %></a>
                                </h4>
                            </div>
                                ...
                                <div class="panel-body">
                                    <ul id = "myTab" class = "nav nav-tabs">
                                        ...
                                        <%
                                            ...
                                            int i = 0;
                                            for(String semester : Globals.Semesters){
                                                if(semester.equals(Globals.SELECT_KEY))
                                                    continue;
                                                else if(semester.equals(Globals.Semesters[1])){
                                        %>
                                        <li class = "active">
                                        ...
                                        %>
                                            <a href = "#sem<%= i++ %>" data-toggle = "tab"><%= semester %></a>
                                        </li>
                                        <%
                                            }
                                        %>
                                        ...
                                        <%
                                            ...
                                            for(String semester : Globals.Semesters){
                                                if(semester.equals(Globals.SELECT_KEY))
                                                    continue;
                                        %>
                                        <div class = "tab-pane fade in active" id = "sem<%= i++ %>">
                                            
                                            <%
                                                ResultSet rs = DBUtils.getStudentsDetails(key, semester);
                                                if(rs.next()){
                                            %>
                                            ...
                                            %>
                                            <div class="alert alert-info" role="alert">No Student Added</div>
                                            <%
                                                }
                                            %>
