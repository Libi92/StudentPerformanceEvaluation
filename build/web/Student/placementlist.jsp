            ...
            <div class="header">
                ...
                <div class="top-menu">
                    ...
                    <ul class="navig">
                        ...
                        <li><a href="placementlist.jsp">Placement List</a></li>
            ...
            <div class="container">
                ...
                <div class="col-md-6 col-md-offset-1">
                    <!--                    <form class="form-horizontal" method="post" action="../ChangePassword">
                                            <input type="hidden" name="returnurl" value="Student/" />
                                            <div class="form-group">
                                                <label class="col-md-4" for="currpassword">Current Password</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="password" class="form-control" name="newpassword" required id="newpassword"  placeholder="New Password" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-4" for="cpassword">Confirm Password</label>
                                                <div class="col-md-8">
                                                    <input type="password" class="form-control" name="cpassword" required id="cpassword" required placeholder="Confirm Password" />
                                                </div>
                                            </div>
                                            <div class="form-group">
                    ...
                    <table class="table table-hover">
                        <th>Name</th><th>Address</th><th>Phone</th><th>Company Name</th><th>Location</th><th>Post</th>
                    <%
                        DBUtils db = new DBUtils();
                        ResultSet rs = db.getData("SELECT * FROM placement,companies,student,placementdrive WHERE placement.status=1 AND companies.companyid=placement.companyid AND placement.studentid=student.loginid AND placement.driveid=placementdrive.placementid");
                        while (rs.next()) {
                            %>
                        <tr align="center"><td><%=rs.getString(11)%></td><td><%=rs.getString("address")%></td><td><%=rs.getString("contact")%></td><td><%=rs.getString("name")%></td><td><%=rs.getString("location")%></td>
                        <td><%=rs.getString("post")%></td></tr>
                        <%
                        }
                    %>
                    </table>
